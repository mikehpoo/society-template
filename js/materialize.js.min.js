...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function(t, e, i, n, a) {
            ...
            return e < 1 ? s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r) * -.5 + i : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r) * .5 + n + i
        },
        ...
        easeInOutBack: function(t, e, i, n, a, o) {
            return void 0 == o && (o = 1.70158), (e /= a / 2) < 1 ? n / 2 * (e * e * ((1 + (o *= 1.525)) * e - o)) + i : n / 2 * ((e -= 2) * e * ((1 + (o *= 1.525)) * e + o) + 2) + i
        },
        ...
        if (!t.jQuery) {
            ...
            i.isWindow = function(t) {
                ...
                if (n) {
                    if (r)
                        for (; o > a && !1 !== i.apply(t[a], n); a++);
                    else
                        for (a in t)
                            if (!1 === i.apply(t[a], n)) break
                } else if (r)
                    for (; o > a && !1 !== i.call(t[a], a, t[a]); a++);
                else
                    for (a in t)
        ...
        return function(t, e, i, n) {
                            ...
                            for (var m = Math.min((e - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                                ...
                                if (r(T)) {
                                    ...
                                    for (var O in C)
                                        if ("element" !== O) {
                                            var A, E = C[O],
                                                I = v.isString(E.easing) ? b.Easings[E.easing] : E.easing;
                                            if (1 === m) A = E.endValue;
                                            else {
                                                var q = E.endValue - E.startValue;
                                                if (A = E.startValue + q * I(m, c, q), !h && A === E.currentValue) continue
                                            }
                                            if (E.currentValue = A, "tween" === O) g = A;
                                            else {
                                                if (x.Hooks.registered[O]) {
                                                    var M = x.Hooks.getRoot(O),
                                                        z = r(T).rootPropertyValueCache[M];
                                                    z && (E.rootPropertyValue = z)
                                                }
                                                var j = x.setPropertyValue(T, O, E.currentValue + (0 === parseFloat(A) ? "" : E.unitType), E.rootPropertyValue, E.scrollData);
            ...
            function d(t, e) {
                ...
                for (var i = b.State.calls[t][0], a = b.State.calls[t][1], o = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                    var d = i[c].element;
                    if (e || o.loop || ("none" === o.display && x.setPropertyValue(d, "display", o.display), "hidden" === o.visibility && x.setPropertyValue(d, "visibility", o.visibility)), !0 !== o.loop && (p.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && r(d)) {
                    ...
                    s && !0 !== o.loop && s(a), r(d) && !0 === o.loop && !e && (p.each(r(d).tweensContainer, function(t, e) {
                    ...
                    var w = function() {
                        ...
                        return function t(e, n, a) {
                            var o, r, s, l = {
                                ...
                                c = [0],
                                u = 0;
                            for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, a = a || null, l.tension = e, l.friction = n, (o = null !== a) ? (u = t(e, n), r = u / a * .016) : r = .016; s = i(s || l, r), c.push(1 + s.x), u += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;);
                            return o ? function(t) {
                        ...
                        Hooks: {
                            ...
                            register: function() {
                                ...
                                if (f)
                                    for (e in x.Hooks.templates) {
                                        ...
                                        "Color" === n[0] && (n.push(n.shift()), a.push(a.shift()), x.Hooks.templates[e] = [n.join(" "), a.join(" ")])
                                    }
                                for (e in x.Hooks.templates) {
                                    n = (i = x.Hooks.templates[e])[0].split(" ");
                                    for (var o in n) {
                            ...
                            injectValue: function(t, e, i) {
                                ...
                                if (n) {
                                    var a, o = n[0],
                                        r = n[1];
                                    return i = x.Hooks.cleanRootPropertyValue(o, i), a = i.toString().match(x.RegEx.valueSplit), a[r] = e, a.join(" ")
                                }
                                return i
                            }
                        },
                        ...
                        getPropertyValue: function(t, i, a, o) {
                            function s(t, i) {
                                ...
                                if (8 >= f) l = p.css(t, i);
                                    ...
                                    var h;
                                    h = r(t) === n ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), ("" === (l = 9 === f && "filter" === i ? h.getPropertyValue(i) : h[i]) || null === l) && (l = t.style[i]), a()
                                }
                            ...
                            if (x.Hooks.registered[i]) {
                                ...
                                var d, h;
                                "transform" !== (d = x.Normalizations.registered[i]("name", t)) && (h = s(t, x.Names.prefixCheck(d)[0]), x.Values.isCSSNullValue(h) && x.Hooks.templates[i] && (h = x.Hooks.templates[i][1])), l = x.Normalizations.registered[i]("extract", t, h)
                            }
                            if (!/^[\d-]/.test(l))
                    ...
                    var C = function() {
                        ...
                        function a() {
                            function t(t) {
                                ...
                                if ("scroll" === O) {
                                    var m, w, C, S = /^x$/i.test(s.axis) ? "Left" : "Top",
                                        A = parseFloat(s.offset) || 0;
                                    s.container ? v.isWrapped(s.container) || v.isNode(s.container) ? (s.container = s.container[0] || s.container, m = s.container["scroll" + S], C = m + p(o).position()[S.toLowerCase()] + A) : s.container = null : (m = b.State.scrollAnchor[b.State["scrollProperty" + S]], w = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === S ? "Top" : "Left")]], C = p(o).offset()[S.toLowerCase()] + A), l = {
                                        scroll: {
                                            rootPropertyValue: !1,
                                            startValue: m,
                                            currentValue: m,
                                    ...
                                    q = p.extend(!0, {}, r(o).tweensContainer);
                                    for (var E in q)
                                        if ("element" !== E) {
                                            var I = q[E].startValue;
                                            q[E].startValue = q[E].currentValue = q[E].endValue, q[E].endValue = I, v.isEmptyObject(y) || (q[E].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + E + "): " + JSON.stringify(q[E]), o)
                                        }
                                    l = q
                                } else if ("start" === O) {
                                    var q;
                                    r(o).tweensContainer && !0 === r(o).isAnimating && (q = r(o).tweensContainer), p.each(g, function(t, e) {
                                    ...
                                    for (var j in g) {
                                        ...
                                        var W = x.Hooks.getRoot(j),
                                            H = !1;
                                        if (r(o).isSVG || "tween" === W || !1 !== x.Names.prefixCheck(W)[1] || x.Normalizations.registered[W] !== n) {
                                            (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(j) && !L && 0 !== V && (L = 0), s._cacheValues && q && q[j] ? (L === n && (L = q[j].endValue + q[j].unitType), H = r(o).rootPropertyValueCache[W]) : x.Hooks.registered[j] ? L === n ? (H = x.getPropertyValue(o, W), L = x.getPropertyValue(o, j, H)) : H = x.Hooks.templates[W][1] : L === n && (L = x.getPropertyValue(o, j));
                                            var N, Q, F, $ = !1;
                                            if (N = f(j, L), L = N[0], F = N[1], N = f(j, V), V = N[0].replace(/^([+-\/*])=/, function(t, e) {
                                                    return $ = e, ""
                                                }), Q = N[1], L = parseFloat(L) || 0, V = parseFloat(V) || 0, "%" === Q && (/^(fontSize|lineHeight)$/.test(j) ? (V /= 100, Q = "em") : /^scale/.test(j) ? (V /= 100, Q = "") : /(Red|Green|Blue)$/i.test(j) && (V = V / 100 * 255, Q = "")), /[\/*]/.test($)) Q = F;
                                            else if (F !== Q && 0 !== L)
                                                if (0 === V) Q = F;
                                                else {
                                                    a = a || function() {
                                                        var t = {
                                                            ...
                                                            a = t.fontSize === M.lastFontSize;
                                                        M.lastParent = t.myParent, M.lastPosition = t.position, M.lastFontSize = t.fontSize;
                                                        var s = 100,
                                                            l = {};
                                                        if (a && n) l.emToPx = M.lastEmToPx, l.percentToPxWidth = M.lastPercentToPxWidth, l.percentToPxHeight = M.lastPercentToPxHeight;
                                                        else {
                                                        ...
                                                        return null === M.remToPx && (M.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === M.vwToPx && (M.vwToPx = parseFloat(e.innerWidth) / 100, M.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = M.remToPx, l.vwToPx = M.vwToPx, l.vhToPx = M.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o), l
                                                    }();
                                                    var X = /margin|padding|left|right|width|text|word|letter/i.test(j) || /X$/.test(j) || "x" === j ? "x" : "y";
                                                    switch (F) {
                                                        case "%":
                                ...
                                l.element && (x.Values.addClass(o, "velocity-animating"), z.push(l), "" === s.queue && (r(o).tweensContainer = l, r(o).opts = s), r(o).isAnimating = !0, T === k - 1 ? (b.State.calls.push([z, h, s, null, P.resolver]), !1 === b.State.isTicking && (b.State.isTicking = !0, u())) : T++)
                            }
                            var a, o = this,
                                s = p.extend({}, b.defaults, y),
                                l = {};
                            switch (r(o) === n && b.init(o), parseFloat(s.delay) && !1 !== s.queue && p.queue(o, s.queue, function(t) {
                            ...
                            }!1 !== b.mock && (!0 === b.mock ? s.duration = s.delay = 1 : (s.duration *= parseFloat(b.mock) || 1, s.delay *= parseFloat(b.mock) || 1)), s.easing = c(s.easing, s.duration), s.begin && !v.isFunction(s.begin) && (s.begin = null), s.progress && !v.isFunction(s.progress) && (s.progress = null), s.complete && !v.isFunction(s.complete) && (s.complete = null), s.display !== n && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = b.CSS.Values.getDisplayType(o))), s.visibility !== n && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, !1 === s.queue ? s.delay ? setTimeout(t, s.delay) : t() : p.queue(o, s.queue, function(e, i) {
                                return !0 === i ? (P.promise && P.resolver(h), !0) : (b.velocityQueueEntryFlag = !0, void t(e))
                        ...
                        if (v.isWrapped(this) ? (s = !1, f = 0, h = this, l = this) : (s = !0, f = 1, h = w ? arguments[0].elements || arguments[0].e : arguments[0]), h = o(h)) {
                                ...
                                case "stop":
                                    ...
                                    return p.each(b.State.calls, function(t, e) {
                                        e && p.each(e[1], function(i, a) {
                                            var o = y === n ? "" : y;
                                            return !0 !== o && e[2].queue !== o && (y !== n || !1 !== e[2].queue) || void p.each(h, function(i, n) {
                                                n === a && ((!0 === y || v.isString(y)) && (p.each(p.queue(n, v.isString(y) ? y : ""), function(t, e) {
                                                    v.isFunction(e) && e(null, !0)
                                                }), p.queue(n, v.isString(y) ? y : "", [])), "stop" === g ? (r(n) && r(n).tweensContainer && !1 !== o && p.each(r(n).tweensContainer, function(t, e) {
                                ...
                                default:
                                    if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                                        if (v.isString(g) && b.Redirects[g]) {
                                            var E = (D = p.extend({}, y)).duration,
                                                I = D.delay || 0;
                                            return !0 === D.backwards && (h = p.extend(!0, [], h).reverse()), p.each(h, function(t, e) {
                                                parseFloat(D.stagger) ? D.delay = I + parseFloat(D.stagger) * t : v.isFunction(D.stagger) && (D.delay = I + D.stagger.call(e, t, k)), D.drag && (D.duration = parseFloat(E) || (/^(callout|transition)/.test(g) ? 1e3 : m), D.duration = Math.max(D.duration * (D.backwards ? 1 - t / k : (t + 1) / k), .75 * D.duration, 200)), b.Redirects[g].call(e, e, D || {}, t, k, h, P.promise ? P : n)
                                            }), t()
                                        }
                            ...
                            if (D.loop = parseInt(D.loop), j = 2 * D.loop - 1, D.loop)
                                for (var V = 0; j > V; V++) {
                                    ...
                                    V === j - 1 && (_.display = D.display, _.visibility = D.visibility, _.complete = D.complete), C(h, "reverse", _)
                                }
                            return t()
                        }
                    };
                    (b = p.extend(C, b)).animate = C;
    ...
    function(t, e, i, n) {
        ...
        function x(t, e) {
            for (var i, a, o = e[0].toUpperCase() + e.slice(1), r = 0; r < lt.length;) {
                if (i = lt[r], (a = i ? i + o : e) in t) return a;
                r++
            }
            return n
        }
        ...
        function S(t) {
            ...
            return new(e || (mt ? W : yt ? Q : gt ? $ : L))(t, P)
        }
        ...
        function O(t, e) {
            ...
            var o = i.firstInput,
                ...
                l = e.center = q(n);
            e.timeStamp = ft(), e.deltaTime = e.timeStamp - o.timeStamp, e.angle = D(s, l), e.distance = j(s, l), A(i, e), e.offsetDirection = z(e.deltaX, e.deltaY), e.scale = r ? _(r.pointers, n) : 1, e.rotation = r ? V(r.pointers, n) : 0, E(i, e);
            var c = t.element;
        ...
        function A(t, e) {
            var i = e.center,
                ...
                a = t.prevDelta || {},
                o = t.prevInput || {};
            (e.eventType === Ct || o.eventType === Tt) && (a = t.prevDelta = {
                x: o.deltaX || 0,
                y: o.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function E(t, e) {
            ...
            if (e.eventType != St && (l > xt || s.velocity === n)) {
                var c = s.deltaX - e.deltaX,
                    u = s.deltaY - e.deltaY,
                    d = M(l, c, u);
                a = d.x, o = d.y, i = pt(d.x) > pt(d.y) ? d.x : d.y, r = z(c, u), t.lastInterval = e
        ...
        function z(t, e) {
            return t === e ? Pt : pt(t) >= pt(e) ? t > 0 ? Ot : At : e > 0 ? Et : It
        }
        ...
        function V(t, e) {
            return D(e[1], e[0], Dt) - D(t[1], t[0], Dt)
        }
        ...
        function L() {
            this.evEl = _t, this.evWin = Lt, this.allow = !0, this.pressed = !1, T.apply(this, arguments)
        }

        function W() {
            this.evEl = Nt, this.evWin = Qt, T.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }
        ...
        function F(t, e) {
            var i = b(t.touches),
                n = this.targetIds;
            if (e & (Ct | kt) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
            ...
            for (a = 0; a < r.length;) n[r[a].identifier] && s.push(r[a]), e & (Tt | St) && delete n[r[a].identifier], a++;
        ...
        function Y(t) {
            this.id = C(), this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = p(this.options.enable, !0), this.state = ie, this.simultaneous = {}, this.requireFail = []
        }

        function B(t) {
            return t & se ? "cancel" : t & oe ? "end" : t & ae ? "move" : t & ne ? "start" : ""
        }

        function U(t) {
            return t == It ? "down" : t == Et ? "up" : t == Ot ? "left" : t == At ? "right" : ""
        }
        ...
        c(L, T, {
            handler: function(t) {
                var e = Vt[t.type];
                e & Ct && 0 === t.button && (this.pressed = !0), e & kt && 1 !== t.which && (e = Tt), this.pressed && this.allow && (e & Tt && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: wt,
                    srcEvent: t
        ...
        t.MSPointerEvent && (Nt = "MSPointerDown", Qt = "MSPointerMove MSPointerUp MSPointerCancel"), c(W, T, {
            handler: function(t) {
                var e = this.store,
                    i = !1,
                ...
                a & Ct && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : a & (Tt | St) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: o,
                    srcEvent: t
            ...
            preventDefaults: function(t) {
                if (!Ut) {
                    ...
                    var n = this.actions,
                        ...
                        o = g(n, ee),
                        r = g(n, te);
                    return a || o && i & qt || r && i & Mt ? this.preventSrc(e) : void 0
                }
            },
        ...
        Y.prototype = {
            ...
            recognize: function(t) {
                var e = s({}, t);
                return d(this.options.enable, [this, e]) ? (this.state & (re | se | 32) && (this.state = ie), this.state = this.process(e), void(this.state & (ne | ae | oe | se) && this.tryEmit(e))) : (this.reset(), void(this.state = 32))
            },
            process: function() {},
            ...
            process: function(t) {
                var e = this.state,
                    ...
                    n = e & (ne | ae),
                    a = this.attrTest(t);
                return n && (i & St || !a) ? e | se : n || a ? i & Tt ? e | oe : e & ne ? e | ae : ne : 32
            }
        }), c(J, Z, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function() {
                var t = this.options.direction,
                    e = [];
                return t & qt && e.push(ee), t & Mt && e.push(te), e
            },
            directionTest: function(t) {
                var e = this.options,
                    ...
                    o = t.deltaX,
                    r = t.deltaY;
                return a & e.direction || (e.direction & qt ? (a = 0 === o ? Pt : 0 > o ? Ot : At, i = o != this.pX, n = Math.abs(t.deltaX)) : (a = 0 === r ? Pt : 0 > r ? Et : It, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = a, i && n > e.threshold && a & e.direction
            },
            attrTest: function(t) {
            ...
            process: function(t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Tt | St) && !o) this.reset();
                else if (t.eventType & Ct) this.reset(), this._timer = a(function() {
            ...
            emit: function(t) {
                this.state === re && (t && t.eventType & Tt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = ft(), this.manager.emit(this.options.event, this._input)))
            }
        }), c(et, Z, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function(t) {
                ...
                return i & (qt | Mt) ? e = t.velocity : i & qt ? e = t.velocityX : i & Mt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pt(e) > this.options.velocity && t.eventType & Tt
            },
            emit: function(t) {
                var e = U(t.direction);
            ...
            process: function(t) {
                ...
                if (n && o && i) {
                    ...
                    if (this.pTime = t.timeStamp, this.pCenter = t.center, s && r ? this.count += 1 : this.count = 1, this._input = t, 0 === this.count % e.taps) return this.hasRequireFailures() ? (this._timer = a(function() {
                        this.state = re, this.tryEmit()
        ...
        ot.prototype = {
            ...
            recognize: function(t) {
                ...
                if (!e.stopped) {
                    ...
                    for (var o = 0; o < n.length;) i = n[o], 2 === e.stopped || a && i != a && !i.canRecognizeWith(a) ? i.reset() : i.recognize(t), !a && i.state & (ne | ae | oe) && (a = e.curRecognizer = i), o++
                }
            },
            get: function(t) {
...
}, Materialize.generateQuoteString = function(t, e) {
    $.getJSON("https://api.forismatic.com/api/1.0/?method=getQuote&lang=en&format=jsonp&jsonp=?", function(i) {
        null === i && ((i = {}).quoteText = "To have a great idea, have a lot of them.", i.quoteAuthor = " -Thomas A. Edison"), quote = '"' + i.quoteText + '"', author = " -" + i.quoteAuthor + '<a id="quotebtn" class="waves-effect waves-teal"><i class="material-icons right" style="margin-left:0;">loop</i></a>', $("#" + t).html(quote), $("#" + e).html(author), $("#quotebtn").click(function() {
            Materialize.generateQuoteString("quote", "author")
        })
    })
}, Materialize.getDuoLingoJSON = function(t) {
    var e = "https://www.duolingo.com/users/" + t;
    $.ajax({
        url: e,
        jsonp: "callback",
        dataType: "jsonp",
        ...
        success: function(t) {
            var e = t;
            console.log(e.language_data.de.streak)
        }
    })
};
var Vel;
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity,
    function(t) {
        t.fn.collapsible = function(e, i) {
            ...
            return e = t.extend(n, e), this.each(function() {
                ...
                function r(t, i) {
                    i || t.toggleClass("active"), e.accordion || "accordion" === f || void 0 === f ? n(t) : o(t), s(t)
                }
                ...
                if ("destroy" !== a)
                    if (i >= 0 && i < p.length) {
                        ...
                        var i = t(e.target);
                        l(i) && (i = c(i)), r(i)
                    }), e.accordion || "accordion" === f || void 0 === f ? r(p.filter(".active").first(), !0) : p.filter(".active").each(function() {
                        r(t(this), !0)
                    });
                else u()
            })
            ...
            return "open" === e ? (this.each(function() {
                ...
                function a(e) {
                    ...
                    if (y.is("body") || (y[0].scrollHeight > y[0].clientHeight && (g = y[0].scrollTop), y[0].scrollWidth > y[0].clientWidth && (m = y[0].scrollLeft)), u + c.innerWidth() > t(window).width() ? p = "right" : u - c.innerWidth() + r.innerWidth() < 0 && (p = "left"), d + c.innerHeight() > i)
                        ...
                        "left" === p ? (f = s.gutter, h = r.position().left + f) : "right" === p && (h = r.position().left + r.outerWidth() - c.outerWidth() + (f = -s.gutter)), c.css({
                        position: "absolute",
                ...
                function o() {
                    l = !1, c.fadeOut(s.outDuration), c.removeClass("active"), r.removeClass("active"), t(document).unbind("click." + c.attr("id")), setTimeout(function() {
                        c.css("max-height", "")
                    }, s.outDuration)
                }
                var r = t(this),
                ...
                if (n(), r.after(c), s.hover) {
                    ...
                    l || (r[0] != e.currentTarget || r.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? r.hasClass("active") && (o(), t(document).unbind("click." + c.attr("id"))) : (e.preventDefault(), s.stopPropagation && e.stopPropagation(), a("click")))
                });
                    ...
                    s.velocity("stop", !0), t("#materialbox-overlay").velocity("stop", !0), t(".materialbox-caption").velocity("stop", !0), t("#materialbox-overlay").velocity({
                        ...
                        complete: function() {
                            e.css({
                                ...
                                top: "",
                                left: ""
                            }), s.removeAttr("style"), s.attr("style", c), s.removeClass("active"), o = !0, i && i.css("overflow", "")
                        }
            ...
            return this.each(function(i) {
                function n(i) {
                    ...
                    var o = a.children("img").first(),
                        ...
                        d = (c + u - l) / (n + u),
                        p = Math.round(r * d);
                    i && o.css("display", "block"), s > c && l < c + u && o.css("transform", "translate3D(-50%," + p + "px, 0)")
                }
                var a = t(this);
            ...
            init: function(e) {
                ...
                return this.each(function(i) {
                    var a, o, r, s, l, c = n + i,
                        ...
                        m = !1,
                        y = function(t) {
                            return Math.ceil(f - t.position().left - t.outerWidth() - u.scrollLeft())
                        },
                        b = function(t) {
                    ...
                    e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1), 0 === (a = t(p.filter('[href="' + location.hash + '"]'))).length && (a = t(this).find("li.tab a.active").first()), 0 === a.length && (a = t(this).find("li.tab a").first()), a.addClass("active"), (g = p.index(a)) < 0 && (g = 0), void 0 !== a[0] && (o = t(a[0].hash)).addClass("active"), u.find(".indicator").length || u.append('<div class="indicator"></div>'), s = u.find(".indicator"), u.append(s), u.is(":visible") && setTimeout(function() {
                        ...
                        f = u.width(), v = Math.max(f, u[0].scrollWidth) / p.length, g < 0 && (g = 0), 0 !== v && 0 !== f && (s.css({
                            right: y(a)
                        }), s.css({
                            left: b(a)
                        }))
                        ...
                        if (t(this).parent().hasClass("disabled")) i.preventDefault();
                            ...
                            m = !0, f = u.width(), v = Math.max(f, u[0].scrollWidth) / p.length, a.removeClass("active");
                            var n = o;
                            a = t(this), o = t(Materialize.escapeHash(this.hash)), p = u.find("li.tab a");
                            a.position();
                            a.addClass("active"), prev_index = g, (g = p.index(t(this))) < 0 && (g = 0), e.swipeable ? h.length && h.carousel("set", g) : (void 0 !== o && (o.show(), o.addClass("active"), "function" == typeof e.onShow && e.onShow.call(this, o)), void 0 === n || n.is(o) || (n.hide(), n.removeClass("active"))), l = setTimeout(function() {
                                m = !1
        ...
        t.fn.tooltip = function(i) {
            ...
            return "remove" === i ? (this.each(function() {
                ...
                var o, r, s, l, c, u, d = function() {
                    o = a.attr("data-html") ? "true" === a.attr("data-html") : i.html, r = a.attr("data-delay"), r = void 0 === r || "" === r ? i.delay : r, s = a.attr("data-position"), s = void 0 === s || "" === s ? i.position : s, l = a.attr("data-tooltip"), l = void 0 === l || "" === l ? i.tooltip : l
                };
                d();
                c = function() {
                    ...
                    "mouseenter.tooltip": function(t) {
                        p = setTimeout(function() {
                            ...
                            var t, i, n, o = a.outerWidth(),
                                ...
                                b = 8,
                                w = 0;
                            "top" === s ? (t = a.offset().top - l - 5, i = a.offset().left + o / 2 - p / 2, n = e(i, t, p, l), h = "-10px", u.css({
                                bottom: 0,
                                left: 0,
                                ...
                                marginTop: l,
                                marginLeft: p / 2 - g / 2
                            })) : "left" === s ? (t = a.offset().top + r / 2 - l / 2, i = a.offset().left - p - 5, n = e(i, t, p, l), v = "-10px", u.css({
                                top: "-7px",
                                right: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: l / 2,
                                marginLeft: p
                            })) : "right" === s ? (t = a.offset().top + r / 2 - l / 2, i = a.offset().left + o + 5, n = e(i, t, p, l), v = "+10px", u.css({
                                top: "-7px",
                                left: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: l / 2,
                                marginLeft: "0px"
                            })) : (t = a.offset().top + a.outerHeight() + 5, i = a.offset().left + o / 2 - p / 2, n = e(i, t, p, l), h = "+10px", u.css({
                                top: 0,
                                left: 0,
                                marginLeft: p / 2 - g / 2
                            })), c.css({
    ...
    function(t) {
        ...
        function n(t) {
            var e, n, a = {
                ...
                o = t && t.ownerDocument;
            return e = o.documentElement, void 0 !== t.getBoundingClientRect && (a = t.getBoundingClientRect()), n = i(o), {
        ...
        t && a.appendChild(o), o.style.opacity = 0, Vel(o, {
            translateY: "-35px",
            opacity: 1
        }, {
            duration: 300,
        ...
        null != s && (r = setInterval(function() {
            null === o.parentNode && window.clearInterval(r), o.classList.contains("panning") || (s -= 20), s <= 0 && (Vel(o, {
                opacity: 0,
                marginTop: "-40px"
            }, {
                duration: 375,
            ...
            init: function(e) {
                ...
                e = t.extend(i, e), t(this).each(function() {
                    ...
                    e.draggable ? (o.length && o.remove(), o = t('<div class="drag-target"></div>').attr("data-sidenav", n), t("body").append(o)) : o = t(), "left" == e.edge ? (a.css("transform", "translateX(-100%)"), o.css({
                        ...
                        window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").length && l ? r(!0) : a.css("transform", "translateX(0%)") : !1 === l && ("left" === e.edge ? a.css("transform", "translateX(-100%)") : a.css("transform", "translateX(100%)"))
                    }), !0 === e.closeOnClick && a.on("click.itemclick", "a:not(.collapsible-header)", function() {
                        r()
                    });
                    var r = function(i) {
                            s = !1, l = !1, t("body").css({
                    ...
                    e.draggable && (o.on("click", function() {
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            ...
                            var n = i.gesture.center.x,
                                ...
                                s = t("#sidenav-overlay"),
                                c = o.innerWidth();
                            if (o.css("overflow", "hidden"), o.width(c), 0 === s.length && ((s = t('<div id="sidenav-overlay"></div>')).css("opacity", 0).click(function() {
                                    r()
        ...
        t(document).ready(function() {
            function e(e) {
                var i = e.css("font-family"),
                    a = e.css("font-size"),
                    o = e.css("line-height");
                a && n.css("font-size", a), i && n.css("font-family", i), o && n.css("line-height", o), "off" === e.attr("wrap") && n.css("overflow-wrap", "normal").css("white-space", "pre"), n.text(e.val() + "\n");
                ...
                return e = t.extend(i, e), this.each(function() {
                    ...
                    if (!t.isEmptyObject(a)) {
                        ...
                        n.off("blur.autocomplete").on("blur.autocomplete", function() {
                            ...
                            13 === i && r >= 0 ? (e = c.children("li").eq(r)).length && (e.trigger("mousedown.autocomplete"), t.preventDefault()) : 38 !== i && 40 !== i || (t.preventDefault(), 38 === i && r > 0 && r--, 40 === i && r < n - 1 && r++, a.removeClass("active"), r >= 0 && c.children("li").eq(r).addClass("active"))
            ...
            function i(t, e, i) {
                var a = t.indexOf(e),
                    o = -1 === a;
                return o ? t.push(e) : t.splice(a, 1), i.siblings("ul.dropdown-content").find("li:not(.optgroup)").eq(e).toggleClass("active"), i.find("option").eq(e).prop("selected", o), n(t, i), o
            }
                        ...
                        var l = t('<ul id="select-options-' + r + '" class="dropdown-content select-dropdown ' + (a ? "multiple-select-dropdown" : "") + '"></ul>'),
                            ...
                            f = function(e, i, n) {
                                var o = i.is(":disabled") ? "disabled " : "",
                                    ...
                                    s = a ? '<input type="checkbox"' + o + "/><label></label>" : "",
                                    c = i.data("icon"),
                                    u = i.attr("class");
                                if (c) {
                                    var d = "";
                                    return u && (d = ' class="' + u + '"'), l.append(t('<li class="' + o + r + '"><img alt="" src="' + c + '"' + d + "><span>" + s + i.html() + "</span></li>")), !0
                                }
                                l.append(t('<li class="' + o + r + '"><span>' + s + i.html() + "</span></li>"))
                            };
                        c.length && c.each(function() {
                            if (t(this).is("option")) a ? f(0, t(this), "multiple") : f(0, t(this));
                            ...
                            t(this).click(function(r) {
                                if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                    ...
                                    a ? (t('input[type="checkbox"]', this).prop("checked", function(t, e) {
                                        return !e
                                    }), s = i(u, o, n), g.trigger("focus")) : (l.find("li").removeClass("active"), t(this).toggleClass("active"), g.val(t(this).text())), m(l, t(this)), n.find("option").eq(o).prop("selected", s), n.trigger("change"), void 0 !== e && e()
                                }
                                r.stopPropagation()
                            })
                        }), n.wrap(s);
        ...
        var e = {
            init: function(e) {
                ...
                return e = t.extend(i, e), this.each(function() {
                    ...
                    function n(t) {
                        t >= c.length ? t = 0 : t < 0 && (t = c.length - 1), (u = l.find(".active").index()) != t && (a = c.eq(u), $caption = a.find(".caption"), a.removeClass("active"), a.velocity({
                            opacity: 0
                        }, {
                    ...
                    var a, o, r, s = t(this),
                        ...
                        t(this).attr("src") !== e && (t(this).css("background-image", "linear-gradient(rgba(0, 0, 0, 0.4),rgba(0, 0, 0, 0.4)),url(" + t(this).attr("src") + ")"), t(this).attr("src", e))
                    ...
                    s.hammer({
                        ...
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            var o;
                            p && (0 === (o = $curr_slide.next()).length && (o = c.first()), o.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                            })), f && (0 === (o = $curr_slide.prev()).length && (o = c.last()), o.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
    ...
    function(t) {
        ...
        t(document).ready(function() {
            ...
            var a = t.extend({}, e, i);
            n.hasAutocomplete = !t.isEmptyObject(a.autocompleteOptions.data), this.init = function() {
                var e = 0;
                n.$el.each(function() {
                    var i = t(this),
                        o = Materialize.guid();
                ...
                var r = t("#" + i);
                n.hasAutocomplete && (a.autocompleteOptions.onAutocomplete = function(t) {
                    n.addChip({
                        tag: t
                    }, e), r.val(""), r.focus()
    ...
    function(t) {
        ...
        var e = function(e) {
                ...
                if (!1 === i.hasClass("active")) {
                    var n, a;
                    !0 === i.hasClass("horizontal") ? a = 40 : n = 40, i.addClass("active"), i.find("ul .btn-floating").velocity({
                        scaleY: ".4",
                        scaleX: ".4",
                        translateY: n + "px",
                        translateX: a + "px"
            ...
            a = function(t) {
                if ("true" === t.attr("data-open")) {
                    ...
                    e = s - n / 2 + o / 2, i = a - r, n / u.width(), t.removeClass("active"), t.attr("data-open", !1), t.css({
    ...
    function(t) {
        ...
        function e(o, s, u, d) {
            ...
            function f() {
                C.data(s, T).addClass(x.input).attr("tabindex", -1).val(C.data("value") ? T.get("select", w.format) : o.value), w.editable || C.on("focus." + b.id + " click." + b.id, function(t) {
            ...
            function v() {
                var e;
                !0 === w.hiddenName ? (e = o.name, o.name = "") : e = (e = ["string" == typeof w.hiddenPrefix ? w.hiddenPrefix : "", "string" == typeof w.hiddenSuffix ? w.hiddenSuffix : "_submit"])[0] + o.name + e[1], T._hidden = t('<input type=hidden name="' + e + '"' + (C.data("value") || o.value ? ' value="' + T.get("select", w.formatSubmit) + '"' : "") + ">")[0], C.on("change." + b.id, function() {
            ...
            var y = !1,
                ...
                T = k.prototype = {
                    ...
                    $node: C,
                    start: function() {
                        return b && b.start ? T : (b.methods = {}, b.start = !0, b.open = !1, b.type = o.type, o.autofocus = o == r(), o.readOnly = !w.editable, o.id = o.id || b.id, "text" != o.type && (o.type = "text"), T.component = new u(T, w), T.$root = t(e._.node("div", p(), x.picker, 'id="' + o.id + '_root" tabindex="0"')), h(), w.formatSubmit && v(), f(), w.container ? t(w.container).append(T.$root) : C.after(T.$root), T.on({
    ...
    function(t) {
        ...
        i.prototype.set = function(t, e, i) {
            ...
            var o, r = this;
            return i = void 0 === i ? t : i, i == -1 / 0 || i == 1 / 0 ? o = i : e.isPlainObject(i) && n.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0], i[1], i[2]), i = n.isDate(i) ? i : r.create().obj) : i = n.isInteger(i) || n.isDate(i) ? r.normalize(new Date(i), a) : r.now(t, i, a), {
            ...
            var a, o, r, s, l = e.isArray(i),
                ...
                u = this.item.view;
            if (l || c) {
                for (c ? (o = i.year, r = i.month, s = i.date) : (o = +i[0], r = +i[1], s = +i[2]), n && n.nav && u && u.month !== r && (o = u.year, r = u.month), o = (a = new Date(o, r + (n && n.nav ? n.nav : 0), 1)).getFullYear(), r = a.getMonth(); new Date(o, r, s).getMonth() !== r;) s -= 1;
                i = [o, r, s]
            }
            return i
            ...
            if ((!a || !a.nav) && (!p && c.disabled(i) || p && c.disabled(i) && (v || o || r) || !p && (i.pick <= f.pick || i.pick >= h.pick)))
                for (p && !v && (!r && d > 0 || !o && d < 0) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : -1), i.pick <= f.pick ? (s = !0, d = 1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : -1)])) : i.pick >= h.pick && (l = !0, d = -1, i = c.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : 1)])), !s || !l);) i = c.create([i.year, i.month, i.date + d]);
            return i
            ...
            return a = a.length && !a.filter(function(t) {
                return e.isArray(t) && "inverted" == t[3] || e.isPlainObject(t) && t.inverted
            }).length, -1 === i.item.enable ? !a : a || t.pick < i.item.min.pick || t.pick > i.item.max.pick
        }, i.prototype.parse = function(t, e, i) {
            var a = this,
                o = {};
            return e && "string" == typeof e ? (i && i.format || ((i = i || {}).format = a.settings.format), a.formats.toArray(i.format).map(function(t) {
                var i = a.formats[t],
            ...
            var a = this;
            return n.isInteger(t) && n.isInteger(i) || "boolean" == typeof t && "boolean" == typeof i ? t === i : (n.isDate(t) || e.isArray(t)) && (n.isDate(i) || e.isArray(i)) ? a.create(t).pick === a.create(i).pick : !(!e.isPlainObject(t) || !e.isPlainObject(i)) && (a.isDateExact(t.from, i.from) && a.isDateExact(t.to, i.to))
        }, i.prototype.isDateOverlap = function(t, i) {
            var a = this,
                o = a.settings.firstDay ? 1 : 0;
            return n.isInteger(t) && (n.isDate(i) || e.isArray(i)) ? (t = t % 7 + o) === a.create(i).day + 1 : n.isInteger(i) && (n.isDate(t) || e.isArray(t)) ? (i = i % 7 + o) === a.create(t).day + 1 : !(!e.isPlainObject(t) || !e.isPlainObject(i)) && a.overlapRanges(t, i)
            ...
            return "flip" == i ? a.flipEnable() : !1 === i ? (a.flipEnable(1), o = []) : !0 === i ? (a.flipEnable(-1), o = []) : i.map(function(t) {
            ...
            var a = this,
                o = a.item.disable,
                r = o.length;
            return "flip" == i ? a.flipEnable() : !0 === i ? (a.flipEnable(1), o = []) : !1 === i ? (a.flipEnable(-1), o = []) : i.map(function(t) {
                var i, s, l, c;
                for (l = 0; l < r; l += 1) {
            ...
            var e = this,
                ...
                h = function(a) {
                    ...
                    return "short_months" == a && (o = i.monthsShort), i.selectMonths && void 0 == a ? n.node("select", n.group({
                        min: 0,
                        max: 11,
                        i: 1,
                        node: "option",
                        ...
                        controls: e.$node[0].id + "_table"
                    }) + ' title="' + i.labelMonthSelect + '"') : "short_months" == a ? null != r ? n.node("div", o[r.month]) : n.node("div", o[l.month]) : n.node("div", o[l.month], i.klass.month)
                },
                v = function(a) {
                    var o = l.year,
                    ...
                    if (r) {
                        ...
                        if (i.selectYears && void 0 == a) return n.node("select", n.group({
                            min: p,
                            max: f,
                            i: 1,
                            node: "option",
            ...
            }, n.node("div", n.node("div", createWeekdayLabel(), "picker__weekday-display") + n.node("div", h("short_months"), i.klass.month_display) + n.node("div", createDayLabel(), i.klass.day_display) + n.node("div", v("raw"), i.klass.year_display), i.klass.date_display) + n.node("div", n.node("div", (i.selectYears, h() + v() + f() + f(1)), i.klass.header) + n.node("table", p + n.node("tbody", n.group({
                min: 0,
                max: 5,
                i: 1,
                node: "tr",
                    ...
                    return [n.group({
                        ...
                        item: function(t) {
                            ...
                            var a = r && r.pick == t.pick,
                                p = s && s.pick == t.pick,
                                f = c && e.disabled(t) || t.pick < u.pick || t.pick > d.pick,
                                h = n.trigger(e.formats.toString, e, [i.format, t]);
                            return [n.node("div", t.date, function(e) {
                                return e.push(l.month == t.month ? i.klass.infocus : i.klass.outfocus), o.pick == t.pick && e.push(i.klass.now), a && e.push(i.klass.selected), p && e.push(i.klass.highlighted), f && e.push(i.klass.disabled), e.join(" ")
                            }([i.klass.day]), "data-pick=" + t.pick + " " + n.ariaAttr({
                                role: "gridcell",
                                label: h,
                                selected: !(!a || e.$node.val() !== h) || null,
    ...
    function(t) {
        ...
        t.fn.characterCounter = function() {
            return this.each(function() {
                var a = t(this);
                a.parent().find('span[class="character-counter"]').length || void 0 !== a.attr("data-length") && (a.on("input", e), a.on("focus", e), a.on("blur", n), i(a))
            })
        }, t(document).ready(function() {
        ...
        var e = {
            init: function(e) {
                ...
                return this.each(function(i) {
                    ...
                    function u(i) {
                        if (j) return i.preventDefault(), i.stopPropagation(), !1;
                        if (!e.fullWidth) {
                            var n = t(i.target).closest(".carousel-item").index();
                            0 !== w % k - n && (i.preventDefault(), i.stopPropagation()), d(n)
                        }
                    }

                    function d(t) {
                        var i = w % k - t;
                        e.noWrap || (i < 0 ? Math.abs(i + k) < Math.abs(i) && (i += k) : i > 0 && Math.abs(i - k) < i && (i -= k)), i < 0 ? W.trigger("carouselNext", [Math.abs(i)]) : i > 0 && W.trigger("carouselPrev", [i])
                    }

                    function p(t) {
                        t.preventDefault(), x = !0, j = !1, D = !1, T = a(t), S = o(t), A = P = 0, q = b, M = Date.now(), clearInterval(z), z = setInterval(l, 100)
                    }

                    function f(t) {
                        var e, i;
                        if (x)
                            if (e = a(t), y = o(t), i = T - e, Math.abs(S - y) < 30 && !D)(i > 2 || i < -2) && (j = !0, T = e, s(b + i));
                            else {
                                if (j) return t.preventDefault(), t.stopPropagation(), !1;
                                D = !0
                            }
                        if (j) return t.preventDefault(), t.stopPropagation(), !1
                    }
                    ...
                    function h(t) {
                        if (x) return x = !1, clearInterval(z), O = b, (A > 10 || A < -10) && (O = b + (P = .9 * A)), O = Math.round(O / C) * C, e.noWrap && (O >= C * (k - 1) ? O = C * (k - 1) : O < 0 && (O = 0)), P = O - b, M = Date.now(), requestAnimationFrame(c), j && (t.preventDefault(), t.stopPropagation()), !1
                    }
                    var v, g, m, b, w, x, C, k, T, S, P, O, A, E, I, q, M, z, j, D, V = n + i,
                        _ = t('<ul class="indicators"></ul>'),
                        L = null,
                        W = t(this),
                        H = W.attr("data-indicators") || e.indicators;
                    if (e.fullWidth && (e.dist = 0, function() {
                        ...
                        }(), H && W.find(".carousel-fixed-item").addClass("with-indicators")), W.hasClass("initialized")) return t(window).trigger("resize"), t(this).trigger("carouselNext", [1e-6]), !0;
                    W.addClass("initialized"), x = !1, b = O = 0, v = [], g = W.find(".carousel-item").first().innerWidth(), m = W.find(".carousel-item").first().innerHeight(), C = 2 * g + e.padding, W.find(".carousel-item").each(function(e) {
                        if (v.push(t(this)[0]), H) {
                            var i = t('<li class="indicator-item"></li>');
                            0 === e && i.addClass("active"), i.click(function(e) {
                                e.stopPropagation(), d(t(this).index())
                            }), _.append(i)
                        }
                    }), H && W.append(_), k = v.length, I = "transform", ["webkit", "Moz", "O", "ms"].every(function(t) {
                        var e = t + "Transform";
                        return void 0 === document.body.style[e] || (I = e, !1)
                    }), t(window).off("resize.carousel-" + V).on("resize.carousel-" + V, function() {
                        e.fullWidth ? (g = W.find(".carousel-item").first().innerWidth(), m = W.find(".carousel-item").first().innerHeight(), C = 2 * g + e.padding, O = b = 2 * w * g) : s()
                    }), void 0 !== window.ontouchstart && (W[0].addEventListener("touchstart", p), W[0].addEventListener("touchmove", f), W[0].addEventListener("touchend", h)), W[0].addEventListener("mousedown", p), W[0].addEventListener("mousemove", f), W[0].addEventListener("mouseup", h), W[0].addEventListener("mouseleave", h), W[0].addEventListener("click", u), s(b), t(this).on("carouselNext", function(t, e) {
        ...
        var e = {
            init: function(e) {
                return this.each(function() {
                    ...
                    a.length || (a = n.wrap(t('<div class="tap-target-wrapper"></div>')).parent()), s.length || (s = t('<div class="tap-target-content"></div>'), n.append(s)), o.length || (o = t('<div class="tap-target-wave"></div>'), r.length || ((r = i.clone(!0, !0)).addClass("tap-target-origin"), r.removeAttr("id"), r.removeAttr("style"), o.append(r)), a.append(o));
                    var l = function() {
                        ...
                        c = function() {
                            ...
                            var c = i.outerWidth(),
                                ...
                                V = C / 2 - z / 2,
                                _ = {};
                            _.top = b ? T : "", _.right = y ? f - S - C : "", _.bottom = w ? h - T - k : "", _.left = m ? S : "", _.position = P, a.css(_), s.css({
                                width: O,
                                height: A,
                                top: E,
                                right: 0,
                    ...
                    "open" == e && (c(), a.is(".open") || (a.addClass("open"), setTimeout(function() {
